...
var plugins = require('./src/plugins/plug-n-play').configure(logging.logger, require('./src/conf/array-plugins'), require('./src/conf/default-mode-plugins'), require('./src/conf/client-silenced-plugins'));
