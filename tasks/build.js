...
function addTasks (gulp) {
  ...
  gulp.task('project:copy-files', ['project:copy-source', 'project:copy-seeds', 'project:copy-assets']);

  gulp.task('project:build', ['project:build:styles', 'project:build:code', 'project:merge-locales', 'project:copy-files']);
}
